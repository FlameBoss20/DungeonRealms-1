...
public class RealmInstance implements Realms {
    ...
    private final String FTP_HOST_NAME = "159.203.189.63";
    private final String FTP_USER_NAME = "realms";
    private final String FTP_PASSWORD = "Y279JRZJ484213172e648899610j201F6hWIN2izgT1Q8nZv8Y";
    private final int FTP_PORT = 21;
    ...
    public void doLogout(Player player) {
        if (!isRealmCached(player.getUniqueId()) || !DungeonRealms.getInstance().canAcceptPlayers()) return;
    ...
    public ListenableFuture<Boolean> downloadRealm(UUID uuid) {
        return MoreExecutors.listeningDecorator(AsyncUtils.pool).submit(() -> {
            ...
            String REMOTE_FILE = "/home/ftp/" + "realms" + "/" + uuid.toString() + ".zip";
