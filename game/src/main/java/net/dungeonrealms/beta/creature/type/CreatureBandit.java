 ...
 */
public class CreatureBandit extends EntityZombie implements IAggressive
{
    ...
    public CreatureBandit(World world, CreatureTier creatureTier, SpawnerObject spawnerObject)
    {
        super(world);
        ...
        this.skulls = Arrays.asList(
                new Base64Skull().getSkullByUrl("http://textures.minecraft.net/texture/e5c41024c5fd5aefe9fe508350b5ff264dd79afb17ccfd41b663229da56eb19"),
        ...
        {
            this.names = Arrays.asList("Experienced", "Creepy", "Strong");
