 ...
 */
public class CreatureTroll extends EntityZombie implements IAggressive
{
    ...
    public CreatureTroll(World world, CreatureTier creatureTier, SpawnerObject spawnerObject)
    {
        super(world);
        ...
        this.skulls = Arrays.asList(
                new Base64Skull().getSkullByUrl("http://textures.minecraft.net/texture/f3fc5f654ca8e14852a4b15d32c6f8fae209afeb585471a899c5f14b9cd8d1"),
                new Base64Skull().getSkullByUrl("http://textures.minecraft.net/texture/3669fb61f44891abaf4f79837f8b66c0afb076674654c2dffaa67a1a21e93f")
        );
        ...
        {
            this.names = Arrays.asList("Strong", "Captain", "Big");
    ...
    public void r()
    {
        ...
        this.targetSelector.a(2, new PathfinderGoalNearestAttackableTarget(this, CreatureGoblin.class, false, true));
    }
    ...
    private void aBE()
    {
        this.setCustomName(ChatColor.AQUA + "[" + level + "]" + ChatColor.DARK_RED + names.get(new Random().nextInt(names.size())) + " Troll");
