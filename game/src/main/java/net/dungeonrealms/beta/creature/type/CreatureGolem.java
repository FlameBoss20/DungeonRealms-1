 ...
 */
public class CreatureGolem extends EntityIronGolem implements IAggressive
{
    ...
    public CreatureGolem(World world, CreatureTier creatureTier, SpawnerObject spawnerObject)
    {
        super(world);
        ...
        if (level >= 35)
        {
            this.getAttributeInstance(GenericAttributes.maxHealth)
                    .setValue(IntegerUtil.randomInteger(creatureTier.getMinHealth(), creatureTier.getMaxHealth()) +
                            IntegerUtil.randomInteger(creatureTier.getMinHealth(), creatureTier.getMaxDmg()) * 2);
        ...
        } else
        {
            ...
            this.getAttributeInstance(GenericAttributes.MOVEMENT_SPEED).setValue(0.22D);
        }

        if (creatureElement == CreatureElement.EMPTY)
        {
            this.names = Arrays.asList("Ironclad", "Forge", "Automaton");
    ...
    public void r()
    {
        ...
        this.goalSelector.a(8, new PathfinderGoalLookAtPlayer(this, Entity.class, 5.0F));
        this.goalSelector.a(8, new PathfinderGoalRandomLookaround(this));
        this.targetSelector.a(1, new PathfinderGoalHurtByTarget(this, true));
        //dis boy kills everything
        this.targetSelector.a(2, new PathfinderGoalNearestAttackableTarget(this, Entity.class, false, true));
    }
    ...
    private void aBE()
    {
        this.setCustomName(ChatColor.AQUA + "[" + level + "]" + ChatColor.DARK_RED + names.get(new Random().nextInt(names.size())) + " Golem");
