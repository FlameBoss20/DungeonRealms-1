 ...
 */
public class CreatureGoblin extends EntityZombie implements IAggressive
{
    ...
    public CreatureGoblin(World world, CreatureTier creatureTier, SpawnerObject spawnerObject)
    {
        super(world);
        ...
        this.skulls = Arrays.asList(
                new Base64Skull().getSkullByUrl("http://textures.minecraft.net/texture/4bf56c6541c1266ffc463510bdb55aef9315af548898cf5d3cba1b5b4c01"),
                new Base64Skull().getSkullByUrl("http://textures.minecraft.net/texture/a585c4da793b8a235737bedc0f9e91ca845a5f3f18a47bea97c6b8ee4d4c2")
        );
        ...
        if (level >= 35)
        {
            ...
            this.getAttributeInstance(GenericAttributes.MOVEMENT_SPEED).setValue(0.334D);
        } else
        {
            this.getAttributeInstance(GenericAttributes.maxHealth)
                    .setValue(IntegerUtil.randomInteger(creatureTier.getMinHealth(), creatureTier.getMaxHealth()));
            ...
            this.getAttributeInstance(GenericAttributes.MOVEMENT_SPEED).setValue(0.355D);
        }

        if (creatureElement == CreatureElement.EMPTY)
        {
            this.names = Arrays.asList("Small", "Commanding", "Strong", "Big");
    ...
    public void r()
    {
        ...
        this.targetSelector.a(2, new PathfinderGoalNearestAttackableTarget(this, CreatureTroll.class, false, true));
    }
    ...
    private void aBE()
    {
        this.setCustomName(ChatColor.AQUA + "[" + level + "]" + ChatColor.DARK_RED + names.get(new Random().nextInt(names.size())) + " Goblin");
